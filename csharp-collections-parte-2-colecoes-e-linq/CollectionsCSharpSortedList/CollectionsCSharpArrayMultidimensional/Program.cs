...
namespace CollectionsCSharpArrayMultidimensional;
class Program
{
    static void Main(string[] args)
    {
        ...
        //Adicionar elementos com indice
        ...
        PopulandoArray(resultados);
    }

    private static void PopulandoArray(string[,] resultados)
    {
    ...
    private static void ImprimirComForeach(string[,] resultados)
    {
